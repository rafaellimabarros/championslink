...
<html lang="pt-br" style="height: 100%; min-height: 100%;">
    ...
    <section class="container text-center text-light" style="margin: auto;">
         ...
         <div class="container">
             <h1 class="pb-4"style="font-size: 30px; color: white; padding: 20px; font-weight: bold; text-shadow: 2px 2px 4px black;"> Rodadas  - Callcenter </h1>
         </div> 
         ...
         <tr>
            ...
            <tr>
            <td>Rodada 01</td>
            <td> <a href="callcenter_rodada01.php"> <button type="button" class="btn btn-primary">Acessar</button> </a> </td>
            </tr>

            <tr>
            <td>Rodada 02</td>
            <td> <a href="callcenter_rodada02.php"> <button type="button" class="btn btn-primary">Acessar</button> </a> </td>
            </tr>
            </tbody>
            </table>
