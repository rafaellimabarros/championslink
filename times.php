...
<html lang="pt-br" style="height: 100%; min-height: 100%;">
    ...
    <section class="container text-center text-light" style="margin: auto;">
         ...
         <div class="bg-dark col m-1 text-dark" style="background-image: url('img/back05.jpg'); background-position: center;  background-repeat: no-repeat; background-size: cover;">
                        <label class="titulorel pt-2" style="font-weight: bold; color:white; font-weight: bold; text-shadow: 2px 2px 4px black; font-size: 28px;"> Times </label>
                        <form name="pontuar" action="times_pontuacao_executa.php" method="POST" class="pt-3">
                    ...
                    <div class="bg-dark col m-1 text-dark" style="background-image: url('img/back05.jpg'); background-position: center;  background-repeat: no-repeat; background-size: cover;">
                        <label class="titulorel pt-2" style="font-weight: bold; color:white; font-weight: bold; text-shadow: 2px 2px 4px black; font-size: 28px;"> Jogadores </label>
                        <form name="pontuar" action="times_jogadores.php" method="POST" class="pt-3">
                                ...
                                <label class="labelform"> Rodada </label>
                                    ...
                                    <input class="btn-sm btn-primary mb-3" style="border-radius: 5px; width: 25%; font-size: 18px; font-weight: bold; text-shadow: 1px 2px 1px black; border: none; box-shadow:1px 1px 4px black; "type="submit" name="enviar" value="Gerar">
                        </form>    
                    </div> 
                </div>
                ...
                <div class="row justify-content-md-center mt-3 mb-4">  
                    <div class="bg-dark col m-1 text-dark" style="background-image: url('img/back05.jpg'); background-position: center;  background-repeat: no-repeat; background-size: cover;">
                        <label class="titulorel pt-2" style="font-weight: bold; color:white; font-weight: bold; text-shadow: 2px 2px 4px black; font-size: 28px;"> Partidas </label>
                        <form name="pontuar" action="partidas.php" method="POST" class="pt-3">
