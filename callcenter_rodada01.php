...
<html lang="pt-br" style="height: 100%; min-height: 100%;">
    ...
    <section class="container text-center text-light" style="margin: auto;">
         ...
         <div class="container">
             <h1 class="pb-4"style="font-size: 30px; color: white; padding: 20px; font-weight: bold; text-shadow: 2px 2px 4px black;"> Rodada 01 - Callcenter </h1>
             
             <?php
                $hoje = date('Y-m-d');
                if($hoje >= '2022-03-14' && $hoje <= '2022-03-18'): ?>
    ...
    <?php
            ...
            where f.id_setor = 2 AND f.perfil is null AND ptr01.id_rodada = '1'
