...
<html lang="pt-br" style="height: 100%; min-height: 100%;">
    ...
    <section class="container text-center text-light" style="margin: auto;">
         ...
         <div class="container">
             <h1 class="pb-4"style="font-size: 30px; color: white; padding: 20px; font-weight: bold; text-shadow: 2px 2px 4px black;"> <?php echo $id_rodada ?> - NOC </h1>

             <a href="NOC_pontuar_rodada.php" style="text-decoration: none;"> <button type="button" class="btn btn-primary mb-3"> Marcar gols </button> </a>           
    ...
    <?php
            ...
            where f.id_setor = 4 AND f.perfil is null AND ptr01.id_rodada = '$id_rodada'
