...
<html lang="pt-br" style="height: 100%; min-height: 100%;">
    ...
    <section class="container text-center text-light" style="margin: auto;">
                    ...
                    <div class="alert alert-success w-50" role="alert" style="transform: translateX(+50%)">
                            <?php echo $_SESSION['funcionario_pontuado'];  ?> foi marcado com sucesso!
                    </div>
                    <?php    
                        endif;
                    ...
                    <div class="alert alert-danger w-50" role="alert" style="transform: translateX(+50%)">
                            Jogador <?php echo $_SESSION['funcionario_pontuado'];  ?> não foi marcado, pois o mesmo já obteve uma marcação de gols hoje.
                    </div>
                    <?php    
                        endif;
         ...
         <div class="col m-1 text-dark" style="background-image: url('img/back05.jpg'); background-position: center;  background-repeat: no-repeat; background-size: cover;">
                        <label class="titulorel pt-2" style="font-weight: bold; color:white; font-weight: bold; text-shadow: 2px 2px 4px black; font-size: 28px;"> Rodadas - Callcenter </label>
                        <form name="pontuar" action="callcenter_consulta_rodadas.php" method="POST" class="pt-3">
